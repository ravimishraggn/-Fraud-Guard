# VPC with public, private (app) and data subnets across two AZs + NAT gateway.
...
resource "aws_subnet" "data" {
  ...
  tags = { Name = "${var.project_name}-${var.environment}-data-${count.index}" }
}
...
# Shared security group for application workloads (EKS nodes / services)
